    ...
    <div className="grid md:grid-cols-3 gap-6">
      <div className="md:col-span-1 space-y-4">
        <div className="card p-6 text-center">
          <AvatarUpload size={80} fallbackClass="bg-brand text-ink" />
          ...
          <span className="badge bg-ink-bg text-ink mt-3">Yo'lovchi</span>
          <div className="mt-4">
            <LogoutButton />
          </div>
        </div>
        ...
        <div className="card p-5">
          ...
          {sub && (
            <>
              <div className="text-3xl font-extrabold text-ink">{sub.days_left} <span className="text-base font-medium text-ink-muted">kun qoldi</span></div>
